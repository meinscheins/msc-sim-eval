function multipath_perf_fm_ax25(delay_min, delay_max, delay_step, attenuation, snr, iterations, csv_dir)
            ...
            for delay = delay_range
                ...
                for k=1:iterations
                    if rate == "2400"
                        ...
                        multipath_fm("out.wav", "output.wav", delay, attenuation, snr);
